import svgPaths from "./svg-71k32nm55t"

export default function TopNav({ className }: { className?: string }) {
  return (
    <div
      className={className || "bg-white h-[72px] relative w-[1600px]"}
      data-name="TopNav"
    >
                ...
                <div className="absolute contents left-0 top-0">
                  <div className="absolute content-stretch flex items-center justify-between left-0 top-0 w-[162px]">
                    ...
                    <div className="content-stretch flex h-[72px] items-center justify-center px-[24px] py-[14px] relative shrink-0">
                      <p className="[word-break:break-word] font-['Pretendard:SemiBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#8694b1] text-[16px] text-center tracking-[-0.32px] whitespace-nowrap">
                        기관회계
                      </p>
                    </div>
                  </div>
            ...
            <div className="content-stretch flex items-center justify-end pr-[24px] relative shrink-0">
              <div className="content-stretch flex items-center justify-end relative shrink-0">
                <div className="content-stretch flex items-center justify-end pl-[8px] pr-[4px] py-[10px] relative shrink-0">
                  ...
                  >
                    ...
                    <div
                      ...
                      data-name="Content"
                    >
                      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[#67748e] text-[14px] tracking-[0.01px]">
                ...
                <div className="content-stretch flex gap-[10px] items-center justify-end pl-[4px] pr-[16px] py-[10px] relative shrink-0">
                  <div
                    className="bg-[#f5f8fc] content-stretch flex h-[44px] items-center px-[12px] py-[4px] relative rounded-[8px] shrink-0"
                    data-name="search"
                  >
                    <div
                      aria-hidden
                    ...
                    >
                      ...
                      <div className="[word-break:break-word] flex flex-col font-['Pretendard:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#a9b1c6] text-[14px] tracking-[0.01px] w-[180px]">
                        <p className="leading-[22px]">검색어를 입력해주세요.</p>
                      </div>
                    </div>
                  </div>
                  <div
                ...
                <div className="content-stretch flex gap-[10px] items-center justify-center pl-[16px] pr-[8px] py-[6px] relative shrink-0">
                  <div
                    aria-hidden
                    className="absolute border-[#e0e6f1] border-l border-solid inset-0 pointer-events-none"
                  />
                  <div
                    className="relative shrink-0 size-[24px]"
